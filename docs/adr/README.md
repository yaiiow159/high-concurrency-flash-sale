...
| [ADR-0028](0028-seckill-qualification-and-risk-control.md) | 搶購資格預檢與風險控管 | 已採納 |
| [ADR-0029](0029-distributed-tracing.md) | 分散式追蹤，以及 Outbox 兩側的 trace 接續 | 已採納 |
| [ADR-0030](0030-publish-timeout-is-not-failure.md) | 投遞逾時不是投遞失敗 | 已採納 |
