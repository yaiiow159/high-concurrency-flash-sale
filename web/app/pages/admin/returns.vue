...
/**
 * 退貨審核。 每一列要讓客服在**不點進去**的情況下就做得了判斷，因此列上直接帶 退貨原因、品項與退款金額——少了任一項都會逼他先點開再回來。 **駁回必須填理由，核准不必。** 這不是對稱的：核准之後使用者拿得到錢， 沒有人會問為什麼；駁回則是一個壞消息，而收到壞消息卻不知道原因 只會變成一通客服電話。
 */
...
/** 需要商家負責的原因。 只用於**提示客服**，不影響任何金額計算——真正的責任歸屬在後端由原因決定。 前端再算一次的話，兩邊的判斷遲早會分歧，而分歧之後沒有人知道哪一邊是對的。 */
