...
/**
 * 會員等級卡。 **電商的會員中心第一屏就是這張卡**，而它要在一眼之內回答三件事： 我是什麼等級、我有多少點、我離下一級還差多少。 三者缺一，使用者就得往下捲——而往下捲的那一刻， 「升級」這個動機就消失了。 每個等級有自己的漸層。用實色的話四個等級只能靠文字分辨， 而「等級」這件事的全部價值就是它要看起來不一樣。
 */
...
/** 等級的視覺。 銅／銀／金／白金各自的色系是真實世界的金屬色，不是隨便挑的—— 使用者不必看文字就知道哪一個比較高階，而那是這套視覺唯一要做的事。 */
